  ...
  routes: [
    ...
    // =============================================================================
      ...
      children: [
        ...
        {
          path: '/apps/todo',
          component: () => import('./../src/views/apps/calendar/SimpleCalendar.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          },
        ...
        {
          path: '/apps/user/subadmin',
          name: 'app-user-subadmin',
          component: () => import('@/views/apps/user/subadmins/subAdmins.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'User' },
        ...
        },
        {
          path: '/apps/cms/pages',
          name: 'app-cms-pages',
          component: () => import('@/views/apps/cms/cms.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'User' },
...

        {
          ...
          name: 'app-user-roles',
          component: () => import('@/views/apps/user/user-roles/userRoles.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'User' },
        ...
        {
          path: '/apps/user/add/subadmins',
          name: 'app-user-addsubadmins', 
          component: () => import('@/views/apps/user/subadmins/addSubadmins/addSubadmins.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'User' },
            ...
            pageTitle: 'Add Subadmin',
            rule: 'editor'
          }
        },

        {
          path: '/apps/roles/add-roles',
          name: 'app-user-roles-add',
          component: () => import('@/views/apps/user/user-roles-add/userRolesAdd.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'User' },
